/**
 * Created by 李远明 on 2017-05-03 14:49.
 * //www.zoakerc.com/
 */
!function(A, i) {
    ...
    return function(A) {
                ...
                return A.toString = function() {
                    ...
                    A.i = function(i, t) {
                        ...
                        for (e = 0; e < i.length; e++) {
                            var o = i[e];
                            "number" == typeof o[0] && s[o[0]] || (t && !o[2] ? o[2] = t : t && (o[2] = "(" + o[2] + ") and (" + t + ")"),
                                A.push(o))
                        }
                    }
                    ,
        ...
        , function(A, i, t) {
            ...
            function n(A, i) {
                var t = l()
                    , s = m[m.length - 1];
                if ("top" === A.insertAt)
                    s ? s.nextSibling ? t.insertBefore(i, s.nextSibling) : t.appendChild(i) : t.insertBefore(i, t.firstChild),
                        m.push(i);
                else {
            ...
            function r(A, i) {
                ...
                if (i.singleton) {
                    ...
                    A.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = a(i),
                            s = d.bind(null, t),
                            e = function() {
                                o(t),
                ...
                return s(A),
                    function(i) {
                        if (i) {
                            if (i.css === A.css && i.media === A.media && i.sourceMap === A.sourceMap)
                                return;
                            s(A = i)
                        } else
                            e()
        ...
        , function(A, i) {
            ...
            function o(A) {
                for (var i = A.length / 4 * 3, t = atob(A), s = new ArrayBuffer(i), e = new Uint8Array(s), n = 0; i > n; n++)
                    e[n] = t.charCodeAt(n);
                return e.buffer
            }
            ...
            function r(A, i, s) {
                var e = (t.defaultDimensions.WIDTH + A.xPos,
                    new I(i.xPos + 1, i.yPos + 1, i.config.WIDTH - 2, i.config.HEIGHT - 2))
            ...
            t.config = {
                ...
                t.prototype = {
                    ...
                    loadImages: function() {
                        Q ? (t.imageSprite = document.getElementById("offline-resources-2x"),
                            this.spriteDef = t.spriteDefinition.HDPI) : (t.imageSprite = document.getElementById("offline-resources-1x"),
                    ...
                    adjustDimensions: function() {
                        ...
                        this.canvas && (this.canvas.width = this.dimensions.WIDTH,
                            ...
                            this.tRex.update(0),
                            this.activated || this.crashed || this.paused ? (this.containerEl.style.width = this.dimensions.WIDTH + "px",
                    ...
                    update: function() {
                        ...
                        if (this.time = A,
                            ...
                            1 != this.tRex.jumpCount || this.playingIntro || this.playIntro(),
                                this.playingIntro ? this.horizon.update(0, this.currentSpeed, t) : (i = this.started ? i : 0,
                                    this.horizon.update(i, this.currentSpeed, t, this.inverted));
                            var s = t && r(this.horizon.obstacles[0], this.tRex);
                            s ? this.gameOver() : (this.distanceRan += this.currentSpeed * i / this.msPerFrame,
                            ...
                            if (e && this.playSound(this.soundFx.SCORE),
                                ...
                                n > 0 && (this.invertTrigger = !(n % this.config.INVERT_DISTANCE),
                                this.invertTrigger && 0 === this.invertTimer && (this.invertTimer += i,
                                    this.invert()))
                            }
                        }
                        this.crashed || (this.tRex.update(i),
                            this.raq())
                    },
                    ...
                    startListening: function() {
                        document.addEventListener(t.events.KEYDOWN, this),
                            ...
                            D ? (this.touchController.addEventListener(t.events.TOUCHSTART, this),
                                this.touchController.addEventListener(t.events.TOUCHEND, this),
                                this.containerEl.addEventListener(t.events.TOUCHSTART, this)) : (document.addEventListener(t.events.MOUSEDOWN, this),
                    ...
                    stopListening: function() {
                        document.removeEventListener(t.events.KEYDOWN, this),
                            ...
                            D ? (this.touchController.removeEventListener(t.events.TOUCHSTART, this),
                                this.touchController.removeEventListener(t.events.TOUCHEND, this),
                                this.containerEl.removeEventListener(t.events.TOUCHSTART, this)) : (document.removeEventListener(t.events.MOUSEDOWN, this),
                                document.removeEventListener(t.events.MOUSEUP, this))
                    },
                    onKeyDown: function(A) {
                        D && A.preventDefault(),
                        this.crashed || !t.keycodes.JUMP[A.keyCode] && A.type != t.events.TOUCHSTART || (this.activated || (this.loadSounds(),
                            this.activated = !0),
                        ...
                        this.activated && !this.crashed && t.keycodes.DUCK[A.keyCode] && (A.preventDefault(),
                    ...
                    raq: function() {
                        this.drawPending || (this.drawPending = !0,
                    ...
                    gameOver: function() {
                        ...
                        this.distanceRan > this.highestScore && (this.highestScore = Math.ceil(this.distanceRan),
                    ...
                    onVisibilityChange: function(A) {
                        document.hidden || document.webkitHidden || "blur" == A.type || "visible" != document.visibilityState ? this.stop() : this.crashed || (this.tRex.reset(),
                                this.play())
                    },
                    ...
                    invert: function(A) {
                        A ? (document.body.classList.toggle(t.classes.INVERTED, !1),
                            this.invertTimer = 0,
                            this.inverted = !1) : this.inverted = document.body.classList.toggle(t.classes.INVERTED, this.invertTrigger)
                    }
                },
                t.updateCanvasScaling = function(A, i, t) {
                    ...
                    return 1 == e && (A.style.width = A.width + "px",
                ...
                E.prototype = {
                    init: function(A) {
                        if (this.cloneCollisionBoxes(),
                            this.size > 1 && this.typeConfig.multipleSpeed > A && (this.size = 1),
                    ...
                    update: function(A, i) {
                        ...
                        this.typeConfig.numFrames && (this.timer += A,
                    ...
                    cloneCollisionBoxes: function() {
                        for (var A = this.typeConfig.collisionBoxes, i = A.length - 1; i >= 0; i--)
                            this.collisionBoxes[i] = new I(A[i].x, A[i].y, A[i].width, A[i].height)
                    }
                },
                E.types = [{
                    type: "CACTUS_SMALL",
                ...
                u.prototype = {
                    ...
                    update: function(A, i) {
                        ...
                        i == u.status.WAITING && (this.animStartTime = h(),
                            this.setBlinkDelay())),
                    ...
                    draw: function(A, i) {
                        ...
                        Q && (s *= 2,
                            ...
                            s += this.spritePos.x,
                            e += this.spritePos.y,
                            this.ducking && this.status != u.status.CRASHED ? this.canvasCtx.drawImage(t.imageSprite, s, e, n, o, this.xPos, this.yPos, this.config.WIDTH_DUCK, this.config.HEIGHT) : (this.ducking && this.status == u.status.CRASHED && this.xPos++,
                                this.canvasCtx.drawImage(t.imageSprite, s, e, n, o, this.xPos, this.yPos, this.config.WIDTH, this.config.HEIGHT))
                    },
                    ...
                    blink: function(A) {
                        ...
                        i >= this.blinkDelay && (this.draw(this.currentAnimFrames[this.currentFrame], 0),
                        1 == this.currentFrame && (this.setBlinkDelay(),
                            this.animStartTime = A))
                    },
                    startJump: function(A) {
                        this.jumping || (this.update(0, u.status.JUMPING),
                    ...
                    setDuck: function(A) {
                        A && this.status != u.status.DUCKING ? (this.update(0, u.status.DUCKING),
                            this.ducking = !0) : this.status == u.status.DUCKING && (this.update(0, u.status.RUNNING),
                                this.ducking = !1)
                    },
                    reset: function() {
                        this.yPos = this.groundYPos,
                ...
                l.prototype = {
                    ...
                    update: function(A, i) {
                        var t = !0
                            , s = !1;
                        if (this.acheivement)
                            this.flashIterations <= this.config.FLASH_ITERATIONS ? (this.flashTimer += A,
                                this.flashTimer < this.config.FLASH_DURATION ? t = !1 : this.flashTimer > 2 * this.config.FLASH_DURATION && (this.flashTimer = 0,
                                        this.flashIterations++)) : (this.acheivement = !1,
                                this.flashIterations = 0,
                                this.flashTimer = 0);
                        else if (i = this.getActualDistance(i),
                                i > this.maxScore && this.maxScoreUnits == this.config.MAX_DISTANCE_UNITS ? (this.maxScoreUnits++,
                                    this.maxScore = parseInt(this.maxScore + "9")) : this.distance = 0,
                            i > 0) {
                            i % this.config.ACHIEVEMENT_DISTANCE == 0 && (this.acheivement = !0,
                                this.flashTimer = 0,
                                s = !0);
                ...
                C.prototype = {
                    ...
                    update: function(A) {
                        this.remove || (this.xPos -= Math.ceil(A),
                            this.draw(),
                        this.isVisible() || (this.remove = !0))
                    },
                    isVisible: function() {
                ...
                p.prototype = {
                    update: function(A, i) {
                        if (A && 0 == this.opacity && (this.currentPhase++,
                            this.currentPhase >= p.phases.length && (this.currentPhase = 0)),
                                A && (this.opacity < 1 || 0 == this.opacity) ? this.opacity += p.config.FADE_SPEED : this.opacity > 0 && (this.opacity -= p.config.FADE_SPEED),
                            this.opacity > 0) {
                            if (this.xPos = this.updateXPos(this.xPos, p.config.MOON_SPEED),
                                    this.drawStars)
                                for (var t = 0; t < p.config.NUM_STARS; t++)
                                    this.stars[t].x = this.updateXPos(this.stars[t].x, p.config.STAR_SPEED);
                            this.draw()
                        } else
                            this.opacity = 0,
                                this.placeStars();
                    ...
                    draw: function() {
                        ...
                        if (Q && (A *= 2,
                            ...
                            for (var h = 0; h < p.config.NUM_STARS; h++)
                                this.canvasCtx.drawImage(t.imageSprite, o, this.stars[h].sourceY, n, n, Math.round(this.stars[h].x), this.stars[h].y, p.config.STAR_SIZE, p.config.STAR_SIZE);
                        this.canvasCtx.drawImage(t.imageSprite, s, this.spritePos.y, A, i, Math.round(this.xPos), this.yPos, e, p.config.HEIGHT),
                            this.canvasCtx.globalAlpha = 1,
                            this.canvasCtx.restore()
                    },
                    placeStars: function() {
                        for (var A = Math.round(this.containerWidth / p.config.NUM_STARS), i = 0; i < p.config.NUM_STARS; i++)
                            this.stars[i] = {},
                ...
                m.prototype = {
                    setSourceDimensions: function() {
                        for (var A in m.dimensions)
                            Q ? "YPOS" != A && (this.sourceDimensions[A] = 2 * m.dimensions[A]) : this.sourceDimensions[A] = m.dimensions[A],
                    ...
                    updateXPos: function(A, i) {
                        ...
                        this.xPos[t] <= -this.dimensions.WIDTH && (this.xPos[t] += 2 * this.dimensions.WIDTH,
                            this.xPos[s] = this.xPos[t] - this.dimensions.WIDTH,
                ...
                f.prototype = {
                    ...
                    updateObstacles: function(A, i) {
                        ...
                        if (this.obstacles = t,
                            ...
                            n && !n.followingObstacleCreated && n.isVisible() && n.xPos + n.width + n.gap < this.dimensions.WIDTH && (this.addNewObstacle(i),
                                n.followingObstacleCreated = !0)
                        } else
